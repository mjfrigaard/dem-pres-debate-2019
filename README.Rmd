...
We've been asked to see if there is a relationship between screen time and Google trend searches for candidates in the Democratic presidential debate. This document outlines the data import, wrangling, and visulizations used to complete this project. 
...
The url above takes you to a summary of the night. The file below will import and wrangle the data set.  
...
We can pass the following search items through the `gtrendsR::gtrends()` function below to download the data into our RStudio environment. The first night of the Democratic presidential debate was June 26, 2019, but the code below will collected data for the last 30 days  
...
Dems2020IOTAirTime7day <- Dems2020Debate01IOTAirTime %>% dplyr::filter(date >= "2019-06-22" & 
                                        date <= "2019-06-30")
```
...
Now we can see Booker is definitely ahead of Warren in terms of hits over time, but what about in terms of `airtime`?
